...
public class ApprovalAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public ApprovalAdapter(Context context, List<MonitoringModel> monitoringModelList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            ...
            context.startActivity(new Intent(context, DetailApprovalActivity.class));
            ...
            mService.getNamaAgenda(list.getID_AGENDA()).enqueue(new Callback<AgendaModel>() {
                ...
                public void onResponse(Call<AgendaModel> call, Response<AgendaModel> response) {
                    if (response.isSuccessful()){
                        ...
                        String aksi = "Lihat Detail Approval Rapat " + namaAgenda + " - " + list.getKEPUTUSAN();
                ...
                public void onFailure(Call<AgendaModel> call, Throwable t) {
                    Log.d("LOG - Approval Detail", t.getMessage());
                }
            });
        });
    }
