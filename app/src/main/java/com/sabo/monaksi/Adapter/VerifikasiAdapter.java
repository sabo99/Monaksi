...
import com.sabo.monaksi.ui.approval.DetailApprovalActivity;
import com.sabo.monaksi.ui.verifikasi.DetailVerifikasiActivity;
...
public class VerifikasiAdapter extends RecyclerView.Adapter<ViewHolder> {

    private Context context;
    private List<MonitoringModel> monitoringModelList;
    private APIRequestData mService;

    public VerifikasiAdapter(Context context, List<MonitoringModel> monitoringModelList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            ...
            context.startActivity(new Intent(context, DetailVerifikasiActivity.class));
            ...
            mService.getNamaAgenda(list.getID_AGENDA()).enqueue(new Callback<AgendaModel>() {
                ...
                public void onResponse(Call<AgendaModel> call, Response<AgendaModel> response) {
                    if (response.isSuccessful()){
                        ...
                        String aksi = "Lihat Detail Verifikasi Rapat " + namaAgenda + " - " + list.getKEPUTUSAN();
                ...
                public void onFailure(Call<AgendaModel> call, Throwable t) {
                    Log.d("LOG - Verifikasi Detail", t.getMessage());
                }
            });
        });
    }
